...
namespace PrescriptionProjectAssignment.Migrations
{
    ...
    [Migration("20220303104822_TestData4")]
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "BEzXJkCVQsdWSEDvZZ8mnx6PhsSQgdzlNwdSMzTQuAw=",
                            RoleId = 1
                        },
                        new
                        {
                            ...
                            FirstName = "Sumit",
                            LastName = "Sumit",
                            Password = "KZ1KzHOOHBhbzwB4lLVQjNs+/xXxGliyd5kszJL7sE0=",
                            RoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Medicine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 2,
                            ExpirationDate = new DateTime(2022, 4, 2, 11, 48, 22, 51, DateTimeKind.Local).AddTicks(9448),
                        ...
                        new
                        {
                            Id = 2,
                            Amount = 2,
                            ExpirationDate = new DateTime(2022, 4, 2, 11, 48, 22, 54, DateTimeKind.Local).AddTicks(1412),
                            Instructions = "Take one daily",
                            Name = "Cialis"
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Patient1",
                            LastName = "Panda",
                            Password = "sHivySA9EJzKVHUJhmZe9KTqKwmv6+y+0tGlkbG0ctg=",
                            RoleId = 3
                        },
                        new
                        {
                            ...
                            FirstName = "Patient2",
                            LastName = "Ko",
                            Password = "VVZuEevhIVijUWenXEeGvPoiIHqGhBAPEx4hKO+HDr0=",
                            RoleId = 3
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Pharmaceut", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Phillip",
                            LastName = "Andersen",
                            Password = "3p58ub2hfZcx51QRXQyghIbe/knRDlkGNoysKykiflg=",
                            PharmacyId = 1,
                            RoleId = 2
                        },
                        new
                        {
                            ...
                            FirstName = "Sebastian",
                            LastName = "Hansen",
                            Password = "cQFTkld3Bys/8nQ55guwCxiNX5xx2/bySJ7qBLntnjU=",
                            PharmacyId = 2,
                            RoleId = 2
                        });
                });
            ...
            modelBuilder.Entity("PrescriptionProjectAssignment.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 3, 3, 11, 48, 22, 54, DateTimeKind.Local).AddTicks(2303),
                            DoctorId = 1,
                            MedicineId = 1,
                            Name = "Test",
                            PatientJournalId = 1
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 3, 3, 11, 48, 22, 54, DateTimeKind.Local).AddTicks(3498),
                            DoctorId = 2,
                            MedicineId = 2,
                            Name = "Test",
                            PatientJournalId = 2
